...
func main() {
    ...
    _ = runInContainer(ctx, builder, []string{"rpm", "--initdb"})
    _ = runInContainer(ctx, builder, []string{"update-ca-trust"})
    _ = runInContainer(ctx, builder, []string{"microdnf", "install", "dnf"})
